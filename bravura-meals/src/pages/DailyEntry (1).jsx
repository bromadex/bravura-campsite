    ...
    <div className="print-page">
      ...
      <div className="print-only" style={{ display: 'none', marginBottom: '16px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          <div style={{ fontSize: '16px', fontWeight: 600 }}>Daily Meal Entry — {fmtDate(date)}</div>
          <div style={{ fontSize: '12px', color: '#555' }}>Printed: {new Date().toLocaleString('en-GB')}</div>
        </div>
      </div>

      {/* ── Header — hidden when printing ── */}
      <div className="no-print" style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '20px', gap: '12px', flexWrap: 'wrap' }}>
        <div>
      ...
      <Card className="no-print" style={{ marginBottom: '16px', padding: '14px 16px' }}>
