  ...
  return (
    <div style={{ padding: '32px 24px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '24px' }}>
        <span className="material-symbols-rounded" style={{ fontSize: '28px', color: '#EF6C00' }}>dashboard</span>
        <h1 style={{ fontSize: '22px', fontWeight: 700, color: THEME.text, margin: 0 }}>Concrete Dashboard</h1>
      </div>
      <div style={{
