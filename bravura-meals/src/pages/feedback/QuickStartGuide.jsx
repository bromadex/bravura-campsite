  ...
  return (
    <div style={{ maxWidth: '860px' }}>
      ...
      <Section icon="person" color={MODULE_COLORS.me || '#00897B'} title="My Workspace — your own HR on your phone">
        <Steps items={[
          <>Open My Workspace (<Code>ES01</Code>) from the round maroon button just above the teal chat button — on every page. Its home screen is a grid of app icons: tap one to open it, and <b>Home</b> to come back. It is yours alone: every signed-in employee can open it. If it says your login isn't linked, ask HR to link it to your employee record.</>,
          ...
          <>Clock in (<Code>ES04</Code>): tap <b>Clock in</b> / <b>Clock out</b> on your phone — you must be on site (location is checked). The work day is 07:00–16:00; time after 16:00 counts as overtime. Your supervisor approves each day's hours.</>,
