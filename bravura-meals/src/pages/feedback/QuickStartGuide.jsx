      ...
      {can('fuel.create') && (
        <Section icon="local_gas_station" color={MODULE_COLORS.fuel} title="Your daily work — fuel">
          <Steps items={[
            ...
            <>Use <Code>FU21</Code> <b>Issue fuel</b> — tab <b>At the pump</b> on a phone, tab <b>Office / batch</b> for paper slips: tap to choose the machine and driver, litres, km/hours, then the <b>driver types their name to sign</b> (no separate acknowledgement). No signal? The fill is kept on the phone and sent later. You are asked for a reason when the driver's licence is expired, the machine was filled in the last few hours, or its allowance is used up.</>,
            <>Fuel managers set <b>allowances</b> per machine or department (week or month) in <Code>FU22</Code> — alerts at 80, 90 and 100%. Hired machines whose contract says the contractor pays for fuel are listed under <b>Hired plant recharges</b>; mark them deducted with the bill number.</>,
            <>Many paper slips? Issue fuel → <b>Import from Excel</b>: download the template, type the slips in, import. Rows with a problem are marked red; fix and import again — saved rows never repeat.</>,
            <>The Fuel dashboard (<Code>FU01</Code>) shows what needs attention, each tank's days of cover and when to reorder, the top users against their expected L/h, and the month's fuel charged out by department and cost centre. Each fill takes its department, cost centre and project from the machine — set them once in Fleet → Machines. Rules (second fill hours, reorder days, dip tolerance per tank) are in Fuel → Settings.</>,
