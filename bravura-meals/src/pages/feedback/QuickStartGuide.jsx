      ...
      {can('inventory.view') && (
        <Section icon="inventory_2" color={MODULE_COLORS.inventory} title="Inventory — items, stock & warehouses">
          <Steps items={[
            ...
            <>Bins & labels (<Code>IN17</Code>) lists the shelves/bins in each store — add one or a range (A01–A20) and print QR labels. Store levels (<Code>IN18</Code>) sets each item's bin, min, max, reorder point and reorder qty per store; reorder suggestions and draft POs use them.</>,
            ...
            <>Scan (<Code>IN22</Code>) on a phone: tap Scan with camera (Chrome on Android) or use a handheld scanner / type the code. An item shows stock in each store with Issue and Count buttons; a bin label shows what is in that bin.</>,
