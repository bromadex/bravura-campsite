...
export const EVENTS = [
  ...
  { code: 'stock_loss',         group: 'Stores',      label: 'Stock count or adjustment — shortage',      debit: 'Stock losses',              credit: 'Stores stock' },
  { code: 'stock_gain',         group: 'Stores',      label: 'Stock count or adjustment — surplus',       debit: 'Stores stock',              credit: 'Stock losses' },
  { code: 'contractor_labour',  group: 'Contractors', label: 'Approved casual / contractor timesheet',   debit: 'Contractor services',       credit: 'Other accruals' },
  { code: 'hired_plant_usage',  group: 'Contractors', label: 'Approved hired-equipment usage log',       debit: 'Hired plant & vehicles',    credit: 'Other accruals' },
  { code: 'sheq_incident_cost', group: 'SHEQ',        label: 'Closed incident with an actual cost',      debit: 'Safety & medical',          credit: 'Other accruals' },
