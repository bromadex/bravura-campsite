  ...
  return (
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: '40px 0' }}>
      ...
      <div style={{ marginBottom: '16px' }}>
        ...
        <div
          onClick={() => setPage('fleet_vehicles')}
          style={{
        ...
        >
          <div style={{
            ...
            <span className="material-symbols-rounded" style={{ fontSize: '20px', color }}>directions_car</span>
          </div>
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: '14px', fontWeight: 500, color: THEME.text }}>Vehicles Registry</div>
            <div style={{ fontSize: '12px', color: THEME.textMed, marginTop: '2px' }}>
              Manage your vehicle fleet — registration, fuel type, tank capacity and department assignments
            </div>
          </div>
      ...
      <div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          {[
            { icon: 'assignment_ind', label: 'Vehicle Assignments', desc: 'Assign vehicles to drivers and projects' },
            { icon: 'build',          label: 'Maintenance Tracker',  desc: 'Service schedules, reminders and history' },
