  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '24px 16px' }}>
      <div style={{ textAlign: 'center', padding: '80px 20px', color: THEME.textLow }}>
        <span className="material-symbols-rounded" style={{ fontSize: 48, color: THEME.outline, display: 'block', margin: '0 auto 12px' }}>policy</span>
        <div style={{ fontSize: 16, fontWeight: 700, color: THEME.text }}>Policies & Compliance</div>
