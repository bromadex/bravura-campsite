...
export function fuelNav(role, can) {
  return [
    ...
    { id: 'fuel_dashboard',     label: 'Dashboard',              section: 'Daily',    icon: 'dashboard' },
    { id: 'fuel_pump',          label: 'Issue at pump',          section: 'Daily',    icon: 'phone_android',     show: can('fuel.create') },
    { id: 'fuel_dips',          label: 'Dipstick log',           section: 'Daily',    icon: 'straighten',        show: can('fuel.create') },
    { id: 'fuel_receipts',      label: 'Tank deliveries',        section: 'Daily',    icon: 'local_shipping',    show: can('fuel.create') },
    { id: 'fuel_issuance',      label: 'Key in paper slips',     section: 'Daily',    icon: 'local_gas_station', show: can('fuel.create') },
    { id: 'fuel_tanks',         label: 'Tanks & transfers',      section: 'Tanks',    icon: 'water',             show: can('fuel.view')   },
    { id: 'fuel_reconciliation',label: 'Reconciliation',         section: 'Tanks',    icon: 'balance',           show: can('fuel.create') },
    { id: 'fuel_allowances',    label: 'Allowances & recharges', section: 'Control',  icon: 'data_usage',        show: can('fuel.view') || can('fuel.create') },
    { id: 'fuel_requests_list', label: 'Fuel requests',          section: 'Control',  icon: 'assignment',        show: can('fuel.view')   },
    { id: 'fuel_issues',        label: 'Issuance history',       section: 'Control',  icon: 'history',           show: can('fuel.view') },
    { id: 'fuel_transactions',  label: 'All transactions',       section: 'Control',  icon: 'receipt_long',      show: can('fuel.view')   },
    { id: 'fuel_vehicle_consumption', label: 'Consumption per machine', section: 'Reports', icon: 'speed',       show: can('fuel.view') },
    { id: 'fuel_cost_allocation',     label: 'Cost allocation',   section: 'Reports',  icon: 'account_balance',   show: can('fuel.view') },
    { id: 'fuel_forecasting',   label: 'Forecasting',            section: 'Reports',  icon: 'trending_up',       show: can('fuel.view') },
    { id: 'fuel_reports',       label: 'Fuel reports',           section: 'Reports',  icon: 'bar_chart',         show: can('fuel.view') },
    { id: 'fuel_request_form',  label: 'Request Fuel',           section: 'Control',  icon: 'send',              show: false },
    { id: 'fuel_report_daily',  label: 'Daily Transactions',     section: 'Reports',  icon: 'today',             show: false },
    { id: 'fuel_report_monthly',label: 'Monthly Consumption',    section: 'Reports',  icon: 'calendar_month',    show: false },
    { id: 'fuel_report_deliveries', label: 'Delivery Report',    section: 'Reports',  icon: 'local_shipping',    show: false },
    { id: 'fuel_settings',      label: 'Settings',               section: 'Settings', icon: 'settings',          show: can('fuel.edit') },
  ].filter(item => item.show !== false)
}
