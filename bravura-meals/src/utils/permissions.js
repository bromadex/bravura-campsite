...
export function fuelNav(role, can) {
  return [
    ...
    { id: 'fuel_dips',          label: 'Dips & reconciliation',  section: 'Daily',    icon: 'straighten',        show: can('fuel.create') },
    { id: 'fuel_receipts',      label: 'Tank deliveries',        section: 'Daily',    icon: 'local_shipping',    show: can('fuel.create') },
    { id: 'fuel_issuance',      label: 'Batch issue entry',     section: 'Daily',    icon: 'local_gas_station', show: false },
    { id: 'fuel_tanks',         label: 'Tanks & transfers',      section: 'Daily',    icon: 'water',             show: can('fuel.view')   },
    { id: 'fuel_reconciliation',label: 'Reconciliation',         section: 'Tanks',    icon: 'balance',           show: false },
