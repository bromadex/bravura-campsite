...
export function fuelNav(role, can) {
  return [
    ...
    { id: 'fuel_pump',          label: 'Issue fuel',             section: 'Daily',    icon: 'phone_android',     show: can('fuel.create') },
    ...
    { id: 'fuel_issuance',      label: 'Batch issue entry',     section: 'Daily',    icon: 'local_gas_station', show: can('fuel.create') },
    ...
    { id: 'fuel_issues',        label: 'Issuance history',       section: 'Control',  icon: 'history',           show: false },
    { id: 'fuel_transactions',  label: 'Transactions',       section: 'Control',  icon: 'receipt_long',      show: can('fuel.view')   },
    { id: 'fuel_vehicle_consumption', label: 'Consumption per machine', section: 'Reports', icon: 'speed',       show: false },
    { id: 'fuel_cost_allocation',     label: 'Cost allocation',   section: 'Reports',  icon: 'account_balance',   show: false },
    { id: 'fuel_forecasting',   label: 'Forecasting',            section: 'Reports',  icon: 'trending_up',       show: false },
