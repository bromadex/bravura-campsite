...
export function fuelNav(role, can) {
  return [
    ...
    { id: 'fuel_reconciliation',label: 'Reconciliation',    section: 'Records',  icon: 'balance',        show: can('fuel.create') },
    { id: 'fuel_shift_report',      label: 'Shift Report',        section: 'Reports', icon: 'summarize',         show: can('fuel.view') },
    { id: 'fuel_report_daily',      label: 'Daily Transactions',  section: 'Reports', icon: 'today',             show: can('fuel.view') },
