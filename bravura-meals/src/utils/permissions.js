...
export function fuelNav(role, can) {
  return [
    ...
    { id: 'fuel_reports',       label: 'Fuel Reports',    section: 'Reports',  icon: 'analytics',      show: can('fuel.view')   },
    { id: 'fuel_vehicle_consumption', label: 'Vehicle Consumption Analysis', section: 'Analytics', icon: 'directions_car',  show: can('fuel.view') },
    { id: 'fuel_cost_allocation',    label: 'Department Cost Allocation',     section: 'Analytics', icon: 'account_balance', show: can('fuel.view') },
    { id: 'fuel_finance_export',     label: 'Finance Export',      section: 'Analytics', icon: 'receipt_long',    show: can('fuel.edit') },
