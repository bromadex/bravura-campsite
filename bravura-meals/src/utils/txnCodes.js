...
export const TXN_CODES = [
  ...
  { code: 'FU14', path: '/fuel/fuel_report_variance',     label: 'Variance Report (retired)',       module: 'fuel' },
  ...
  { code: 'FL22', path: '/fleet/fleet_small_assets',   label: 'Small Assets (issued to people)', module: 'fleet' },
  ...
  { code: 'CA06', path: '/campsite/camp_supplies',    label: 'Camp Supplies → Stores issues', module: 'campsite' },
  { code: 'CA07', path: '/campsite/camp_transfers',   label: 'Camp transfers → Move between stores', module: 'campsite' },
  ...
  { code: 'IN08', path: '/inventory/inv_site_moves',   label: 'Move between stores',  module: 'inventory' },
  ...
  { code: 'IN11', path: '/inventory/inv_reports',      label: 'Stores reports',       module: 'inventory' },
  { code: 'IN12', path: '/inventory/inv_settings',     label: 'Stores settings',      module: 'inventory' },
  ...
  { code: 'PR03', path: '/procurement/proc_rfqs',      label: 'Quotes (PO hub)',       module: 'procurement' },
  { code: 'PR04', path: '/procurement/proc_orders',    label: 'Purchase Orders',       module: 'procurement' },
  { code: 'PR05', path: '/procurement/proc_tracking',  label: 'Order Tracking (PO hub)', module: 'procurement' },
  ...
  { code: 'PR08', path: '/procurement/proc_grn',          label: 'Receiving',             module: 'procurement' },
  { code: 'PR09', path: '/procurement/proc_invoices',     label: 'Purchase Invoices',     module: 'procurement' },
  { code: 'PR10', path: '/procurement/proc_rfq_compare',  label: 'Quote Comparison (PO hub)', module: 'procurement' },
  ...
  { code: 'PR13', path: '/procurement/proc_agreements',  label: 'Agreements (blanket orders & templates)', module: 'procurement' },
  // ── Finance ──
